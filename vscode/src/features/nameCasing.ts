    ...
    const select = await quickPick([
      {
        '1': {
          label:
            (currentTagNameCasing === TagNameCasing.Kebab ? '• ' : '') +
            'Component Name Using kebab-case',
        },
        '2': {
          label:
            (currentTagNameCasing === TagNameCasing.Pascal ? '• ' : '') +
      ...
      },
      {
        '5': {
          label:
            (currentAttrNameCasing === AttrNameCasing.Kebab ? '• ' : '') +
            'Prop Name Using kebab-case',
        },
        '6': {
          label:
            (currentAttrNameCasing === AttrNameCasing.Camel ? '• ' : '') +
            'Prop Name Using camelCase',
        },
